...
class AdminsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'phone_no' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'created_at' => '2021-05-10 13:11:22',
                'modified_at' => '2021-05-10 13:11:22',
            ],
        ];
        parent::init();
    }
