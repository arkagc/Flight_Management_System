        ...
        <div class="flights form content">
            ...
            <fieldset>
                <?php
                    ...
                    echo $this->Form->control('source_id', ['empty' => '-- Select Source -- ', 'options' => $source]);
                    echo $this->Form->control('destination_id', ['empty' => '-- Select Destination', 'options' => $destination]);
